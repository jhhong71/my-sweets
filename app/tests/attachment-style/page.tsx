...
export const metadata: Metadata = {
  title: "나의 연애 애착 유형은?",
  description:
    "안정형테스트 · 12문항으로 밀착도·표현도·안정도 세 가지 연애 성향 축을 계산해 8가지 애착 유형 중 나와 가장 가까운 하나와 궁합이 맞는 유형을 알려드려요.",
  // "안정형" 계열 검색어로 유입될 수 있도록 실제 결과 축에 쓰이는 표현
  // 그대로만 넣는다(이 테스트에 없는 회피형·불안형 같은 용어는 넣지 않는다).
  keywords: [
    "안정형테스트",
    "안정형 테스트",
    "애착유형테스트",
