    ...
    <main className="screen info-screen">
      ...
      <section className="info-section">
        ...
        <p>
          ...
          전송하지 않습니다. 결과 공유 링크에는 캐릭터 ID만 담기고 개인 응답
          내용은 포함되지 않습니다.
        </p>
      </section>
      ...
      <section className="info-section">
        <h2>테스트의 성격과 한계</h2>
        <p>
          본 테스트는 데이팅 예능에서 흔히 보이는 연애 성향 유형을 참고해 새로
          만든 <strong>비공식 엔터테인먼트 콘텐츠</strong>입니다. 특정 방송
          프로그램, 출연자, 제작사와 아무런 관련이 없으며 제휴·후원 관계도
          없습니다. 등장하는 이름은 한국에서 흔히 쓰이는 이름을 유형 이름으로
          사용한 것이고, 캐릭터 설명은 모두 창작한 내용입니다.
        </p>
        <p>
          과학적으로 검증된 성격검사가 아니며, 전문 심리 진단이나 상담의 근거로
          사용할 수 없습니다. 결과는 그날의 기분이나 상황에 따라 달라질 수
          있습니다.
        </p>
      </section>
