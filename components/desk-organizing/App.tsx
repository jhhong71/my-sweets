...
const DESK_ORGANIZING_TEST_ID = "desk-organizing";
...
export default function App() {
  ...
  const start = () => {
    ...
    void recordParticipation(DESK_ORGANIZING_TEST_ID);
    setScreen("quiz");
  };
  ...
  return (
    // data-screen이 이 요소에 있어야 desk-organizing.css의 배경 테마 규칙
    // (.desk-organizing-app[data-screen="..."])이 적용된다. 제거하면 배경이 안 바뀐다.
    <div className="desk-organizing-app" data-screen={screen}>
