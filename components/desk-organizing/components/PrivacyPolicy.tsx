  ...
  return (
    <main className="screen info-screen">
      ...
      <section className="info-section">
        <h2>광고 및 제휴 안내</h2>
        <p>
          이 서비스는 운영을 위해 Google AdSense, 카카오 애드핏 광고와 쿠팡파트너스
          추천 영역을 둘 수 있습니다. 광고 서비스는 광고 제공을 위해 쿠키 또는
          기기 식별자를 사용할 수 있습니다. 질문을 진행하는 화면에는 광고를 넣지
          않습니다.
        </p>
