  ...
  return (
    <main className="screen info-screen">
      ...
      <section className="info-section">
        <h2>테스트의 성격과 한계</h2>
        <p>
          본 테스트는 선택한 상황과 취향을 바탕으로 나와 가까운 캐릭터 유형을
          재미로 알려주는 <strong>팬이 만든 비공식 엔터테인먼트 콘텐츠</strong>
          입니다. 워너 브라더스·J.K. 롤링 및 해리포터 시리즈의 공식 제작사와
          관련이 없으며, 원작의 문장이나 이미지를 사용하지 않습니다. 과학적으로
          검증된 성격검사가 아니며, 전문 심리 진단이나 질병·정신건강 상태 판정,
          채용·인사평가의 근거로 사용할 수 없습니다.
        </p>
      </section>
