...
import type { AxisScores, ResultOutcome } from "./types";
...
const WORK_LEARNING_TEST_ID = "work-learning";
 ...
 * 않는다(축 점수 섹션·이유 섹션을 모두 숨김) — 타입을 맞추기 위한 값일 뿐이다.
 */
...
export default function App() {
  ...
  const start = () => {
    ...
    void recordParticipation(WORK_LEARNING_TEST_ID);
    setScreen("quiz");
  };
