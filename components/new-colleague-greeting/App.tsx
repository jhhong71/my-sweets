...
const NEW_COLLEAGUE_GREETING_TEST_ID = "new-colleague-greeting";
...
export default function App() {
  ...
  const start = () => {
    ...
    void recordParticipation(NEW_COLLEAGUE_GREETING_TEST_ID);
    setScreen("quiz");
  };
  ...
  return (
    <div className="new-colleague-greeting-app">
