  ...
  return (
    <main className="screen start-screen">
      <div className="hero">
        ...
        <div className="hero-stage">
          <div className="hero-char">
            <CharacterImage id="pqf" size={220} title="새 동료 첫인사 스타일 테스트 대표 이미지" />
          </div>
        </div>
      </div>

      <p className="eyebrow">새 동료 첫인사 스타일 테스트</p>
      ...
      <p className="start-lead">
        회사에 새로운 동료가 들어왔을 때, 요즘의 나는 어떻게 행동할까요?{" "}
        <strong>접근 방식·질문 방식·친밀감 형성 속도</strong> 세 가지 축으로,
        8가지 유형 중 나와 가장 가까운 하나를 찾아드려요.
      </p>
      ...
      <ul className="cast" aria-label="만날 수 있는 새 동료 첫인사 유형 미리보기">
