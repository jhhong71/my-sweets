  ...
  return (
    <main className="screen info-screen">
      ...
      <section className="info-section">
        <h2>테스트의 성격과 한계</h2>
        <p>
          본 테스트는 선택한 상황과 취향을 바탕으로 나와 가까운 새 동료 첫인사
          유형을 재미로 알려주는 <strong>엔터테인먼트 콘텐츠</strong>입니다.
          과학적으로 검증된 성격검사가 아니며, 전문 심리 진단이나 질병·정신건강
          상태 판정, 채용·인사평가의 근거로 사용할 수 없습니다. 결과는 그날의
          분위기나 상대와의 관계, 조직 문화에 따라 달라질 수 있습니다.
        </p>
      </section>
