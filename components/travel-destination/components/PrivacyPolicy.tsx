    ...
    <main className="screen info-screen">
      ...
      <section className="info-section">
        ...
        <p>
          ...
          전송하지 않습니다. 결과 공유 링크에는 여행지 ID만 담기고 개인 응답
          내용은 포함되지 않습니다.
        </p>
      </section>
      ...
      <section className="info-section">
        <h2>테스트의 성격과 한계</h2>
        <p>
          본 테스트는 선택한 상황과 취향을 바탕으로 나와 가까운 여행지를 재미로
          알려주는 <strong>엔터테인먼트 콘텐츠</strong>입니다. 과학적으로
          검증된 성격검사나 여행 추천 알고리즘이 아니며, 실제 여행 계획이나
          예약의 근거로 사용할 수 없습니다. 결과는 그날의 기분이나 함께 가는
          사람에 따라 달라질 수 있습니다.
        </p>
      </section>
