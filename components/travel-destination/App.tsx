...
const TRAVEL_DESTINATION_TEST_ID = "travel-destination";
...
/** 공유 링크(?result=)의 여행지 ID. 결과 데이터에 없는 값이면 무시한다. */
...
export default function App() {
  ...
  const start = () => {
    ...
    void recordParticipation(TRAVEL_DESTINATION_TEST_ID);
    setScreen("quiz");
  };
  ...
  // 직접 테스트한 결과가 있으면 그것을, 없고 공유 링크로 열렸다면 여행지 소개를 보여준다.
  ...
  return (
    <div className="travel-destination-app">
      <div className="app-frame">
        ...
        {screen === "result" &&
          (shownResult ? (
            ...
            // 결과도 공유 여행지도 없는 상태로 결과 화면에 들어온 경우의 안전한 대체 화면
