  ...
  return (
    <main className="screen start-screen">
      <div className="hero">
        ...
        <div className="hero-stage">
          <div className="hero-char">
            <CharacterImage id="dcf" size={220} title="아침 출근 준비 스타일 테스트 대표 이미지" />
          </div>
        </div>
      </div>

      <p className="eyebrow">출근 준비 스타일 테스트</p>
      ...
      <p className="start-lead">
        알람이 울렸을 때, 눈을 떴을 때, 요즘의 나는 어떻게 출근을 준비할까요?
        <strong> 준비 리듬·정보 습관·컨디션 대응</strong> 세 가지 축으로, 8가지
      ...
      <ul className="cast" aria-label="만날 수 있는 아침 준비 유형 미리보기">
