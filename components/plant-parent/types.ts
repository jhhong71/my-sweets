/** 반려식물 돌봄 행동 축 3개. 각 축은 서로 반대되는 두 극(pole)을 가진다. */
export type Axis = "routine" | "care" | "explore";

/** 축의 두 극. high = 루틴형/밀착형/탐험형, low = 즉흥형/여유형/안정형 */
...
/**
 * 8개 결과 유형 키 = 축별 극의 조합
 * (routine: r/i · care: c/e · explore: s/x)
 */
