  ...
  return (
    <main className="screen info-screen">
      ...
      <section className="info-section">
        <h2>수집하는 개인정보</h2>
        <p>
          이 테스트는 회원가입이 없으며 이름, 연락처, 이메일, 주소, 생년월일
          등 개인을 식별할 수 있는 정보를 수집하지 않습니다. 선택한 답변은
      ...
      <section className="info-section">
        <h2>테스트의 성격과 한계</h2>
        <p>
          본 테스트는 대중적으로 잘 알려진 그리스·로마 신화 속 신들의 이미지를
          네 가지 성향 축으로 재해석해 나와 가까운 신을 재미로 알려주는{" "}
          <strong>엔터테인먼트 콘텐츠</strong>입니다. 과학적으로 검증된
          성격검사가 아니며, 전문 심리 진단이나 질병·정신건강 상태 판정,
