  ...
  return (
    <main className="screen start-screen">
        ...
        <div className="hero-stage">
          <div className="hero-char">
            <CharacterImage
              id="smd"
              size={130}
              title="스마트폰 홈 화면 정리 유형 테스트 대표 이미지"
            />
          </div>
        </div>
      </div>

      <p className="eyebrow">스마트폰 홈 화면 정리 유형 테스트</p>
      ...
      <p className="start-lead">
        평소 스마트폰 홈 화면을 어떻게 관리하고 있나요?{" "}
        <strong>정리 구조·아이콘 밀도·꾸미기 성향</strong> 세 가지 축으로,
      ...
      <ul className="cast" aria-label="만날 수 있는 홈 화면 정리 유형 미리보기">
