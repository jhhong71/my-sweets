...
const MONEY_HABIT_TEST_ID = "money-habit";
...
export default function App() {
  ...
  const start = () => {
    ...
    void recordParticipation(MONEY_HABIT_TEST_ID);
    setScreen("quiz");
  };
    ...
    <div className="money-habit-app">
      <div className="app-frame">
        ...
        {screen === "result" && !outcome && sharedResult && (
          <ResultScreen
            outcome={{ primary: sharedResult, match: sharedResult, scores: PLACEHOLDER_SCORES }}
            sharedPreview
            onRestart={restart}
