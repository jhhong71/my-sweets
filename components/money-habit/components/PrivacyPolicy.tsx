  ...
  return (
    <div className="screen info-screen">
      ...
      <section className="info-section">
        <h3>개인정보처리방침</h3>
        <p>
          나는 어떤 머니타입? 돈 관리 습관 유형 테스트는 별도의 회원가입이나
          로그인 없이 이용할 수 있는 웹 서비스이며, 이름·이메일 등 개인을
      ...
      <section className="info-section">
        ...
        <p>
          이 테스트는 Dew &amp; Xiao(2011)가 개발한 Financial Management
          Behavior Scale이 제시한 재무관리 행동 하위영역 중 현금흐름 관리,
          저축, 신용관리 3가지 개념 정의만 참고해 만든 엔터테인먼트
          콘텐츠입니다. 문항은 원척도를 번역한 것이 아니라 축 개념만
          참고해 새로 작성했으며, 원척도의 신뢰도·타당도가 이 앱에 그대로
          적용된다고 보장하지 않습니다. 전문적인 재무 상담이나 심리 진단
          목적으로 사용할 수 없습니다.
        </p>
      </section>

      <p className="info-updated">최종 업데이트: 2026-08-14</p>
    </div>
  );
}
