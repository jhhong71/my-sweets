/** 메신저 답장 습관 행동 축 3개. 각 축은 서로 반대되는 두 극(pole)을 가진다. */
export type Axis = "speed" | "express" | "initiative";

/** 축의 두 극. high = 즉답 / 풍성한 표현 / 대화 주도, low = 여유 / 간결한 표현 / 반응 위주 */
...
/** 8개 결과 유형 키 = 축별 극의 조합 (speed q/w · express v/c · initiative l/r) */
...
/** 결과 카드에 쓰는 캐릭터 종류 (src/assets/characters/*.png) */
export type IconId =
  | "megaphone"
  | "heartbubble"
  | "bulb"
